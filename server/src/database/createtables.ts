...
export class TableCreationList {
	...
	addUserTable(){
		...
		return new Table("user", userTableColumns);
	}
	...
	addItemTable(){
		...
		return new Table("items", itemTableColumns);
	}
	...
	addOrderTable(){
		...
		return new Table("`order`", orderTableColumns);
	}
	...
	addBasketTable(){
		...
		return new Table("basket", basketTableColumns);
	}
	...
	addBasketItemsTable(){
		...
		return new Table("basket_items", basketItemsTableColumns);
	}
	...
	addOrderItemsTable(){
		...
		return new Table("order_items", orderItemsTableColumns);
	}
}
